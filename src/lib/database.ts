...
import { Backups } from './database/backups'
...
export class Database {
	...
	*/
	...
	backup(callback) {
		return this.backups.backup(callback)
	}

	restore(backupData: any[], callback) {
		return this.backups.restore(backupData, callback)
	}

	restoreFile(file: string, callback) {
		return this.backups.restoreFile(file, callback);
	}
}
