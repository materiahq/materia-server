...
class Versionning {
	...
	_compareField(field1, field2) {
		...
		// TODO: a better check if both have different groups
		if (field1.unique != field2.unique
			&& ! ((typeof field1.unique) == 'string' && (typeof field2.unique) == 'string')) {
			diff[0].unique = field1.unique
			diff[1].unique = field2.unique
			found = true
		}
