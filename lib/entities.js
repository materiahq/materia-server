...
class Entities {
	constructor(app) {
		...
		this.app.history.register('create_entity', (data) => {
			this.add(data.value, true)
		})
		
		this.app.history.register('rename_entity', (data) => {
			this.get(data.table).rename(data.value, true)
		})
		
		this.app.history.register('delete_entity', (data) => {
			this.remove(data.table, true)
		})
		
		this.app.history.register('add_field', (data) => {
...
//		})
		...
		this.app.history.register('remove_field', (data) => {
