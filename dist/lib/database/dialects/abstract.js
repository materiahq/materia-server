...
class AbstractDialect {
    ...
    addColumn(table, column_name, attributes) {
        return this.sequelize.getQueryInterface().addColumn(table, column_name, attributes);
    }
    changeColumn(table, column_name, attributes) {
        return this.sequelize.getQueryInterface().changeColumn(table, column_name, attributes);
    }
...
exports.AbstractDialect = AbstractDialect;
